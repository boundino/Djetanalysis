                      ...
                      Bool_t verbose=false)
{
  ...
  finalplot::preparehist(plotPYTHIA);
  ...
  for(int i=0;i<nPtBins;i++)
    {
      for(int l=0;l<2;l++)
        {
          xjjroot::setthgrstyle((hSignalXsubP.at(l))[1*nPtBins+i], fmcolor[1], fmstyle[1], 1.2, fmcolor[1], 1, 2, -1, -1, -1);
          xjjroot::setthgrstyle((gSignalXsubP.at(l))[1*nPtBins+i], fmcolor[1], fmstyle[1], 1.2, 0, 1, 1, ffcolor[1], 0.7, 1001);
          xjjroot::setthgrstyle((hSignalXsubP.at(l))[0*nPtBins+i], fmcolor[0], fmstyle[0], 1.2, fmcolor[0], 1, 2, -1, -1, -1);
          xjjroot::setthgrstyle((gSignalXsubP.at(l))[0*nPtBins+i], fmcolor[0], fmstyle[0], 1.2, 0, 1, 1, ffcolor[0], 0.7, 1001);
          xjjroot::setthgrstyle((hSignalXsubRatio.at(l))[i], kBlack, fmstyle[1], 1.2, kBlack, 1, 2, -1, -1, -1);
          xjjroot::setthgrstyle((gSignalXsubRatio.at(l))[i], kBlack, fmstyle[1], 1.2, 0, 1, 1, kGray+1, 0.7, 1001);
        }
      xjjroot::setthgrstyle((hSignalXsubP.at(0))[1*nPtBins+i], kViolet-7, fmstyle[1]+4, 1.2, kViolet-7, 1, 2, -1, -1, -1);
      xjjroot::setthgrstyle((hSignalXsubP.at(0))[0*nPtBins+i], kViolet-7, fmstyle[0]+4, 1.2, kViolet-7, 1, 2, -1, -1, -1);
      xjjroot::setthgrstyle((hSignalXsubRatio.at(0))[i], kViolet-7, fmstyle[1]+4, 1.2, kViolet-7, 1, 2, -1, -1, -1);
      if(plotPYTHIA)
        {
          xjjroot::setthgrstyle((hSignalXsubRatioPYTHIA.at(1))[i], fmcolor[2], fmstyle[2], 1.2, fmcolor[2], 1, 2, -1, -1, -1);
          xjjroot::setthgrstyle((gSignalXsubRatioPYTHIA.at(1))[i], fmcolor[2], fmstyle[2], 1.2, 0, 1, 1, ffcolor[2], 0.7, 1001);
          xjjroot::setthgrstyle(ahSignalRsubPYTHIA[i], fmcolor[2], fmstyle[2], 1.2, fmcolor[2], 1, 2, -1, -1, -1);
          xjjroot::setthgrstyle(agSignalRsubPYTHIA[i], fmcolor[2], fmstyle[2], 1.2, 0, 1, 1, ffcolor[2], 0.7, 1001);
          xjjroot::setthgrstyle(ahSignalRsubRatioPYTHIAPP[i], fmcolor[2], fmstyle[2], 1.2, fmcolor[2], 1, 2, -1, -1, -1);
      ...
      for(int i=0;i<nPtBins;i++)
        {
          ...
          (gSignalXsubP.at(l))[1*nPtBins+i]->Draw("2 same");
          (hSignalXsubP.at(l))[1*nPtBins+i]->Draw("pe same");
          legonly->AddEntry((gSignalXsubP.at(l))[1*nPtBins+i], fleg[1], "pf");
          (gSignalXsubP.at(l))[0*nPtBins+i]->Draw("2 same");
          (hSignalXsubP.at(l))[0*nPtBins+i]->Draw("pe same");
          ...
          if(jetetamin<0.3) conly->SaveAs(Form("plotfinal/cfinal_xsec_%s_r_pt_%s_%s%s_dNdronly.pdf",outputname.Data(),xjjc::number_to_string(ptBins[i]).c_str(),xjjc::number_to_string(ptBins[i+1]).c_str(),tname[l].Data()));
          ...
          if(jetetamin<0.3) cratioonly->SaveAs(Form("plotfinal/cfinal_xsec_%s_r_pt_%s_%s%s_ratioonly.pdf",outputname.Data(),xjjc::number_to_string(ptBins[i]).c_str(),xjjc::number_to_string(ptBins[i+1]).c_str(),tname[l].Data()));
          ...
          (gSignalXsubP.at(l))[1*nPtBins+i]->Draw("2 same");
          (hSignalXsubP.at(l))[1*nPtBins+i]->Draw("pe same");
          legdNdrratio->AddEntry((gSignalXsubP.at(l))[1*nPtBins+i], fleg[1], "pf");
          (gSignalXsubP.at(l))[0*nPtBins+i]->Draw("2 same");
          (hSignalXsubP.at(l))[0*nPtBins+i]->Draw("pe same");
          ...
          (gSignalXsubP.at(l))[1*nPtBins+i]->Draw("2 same");
          (hSignalXsubP.at(l))[1*nPtBins+i]->Draw("pe same");
          legdNdrpythia->AddEntry((gSignalXsubP.at(l))[1*nPtBins+i], fleg[1], "pf");
          (gSignalXsubP.at(l))[0*nPtBins+i]->Draw("2 same");
          (hSignalXsubP.at(l))[0*nPtBins+i]->Draw("pe same");
          legdNdrpythia->AddEntry((gSignalXsubP.at(l))[0*nPtBins+i], fleg[0], "pf");
          agSignalRsubPYTHIA[i]->Draw("2 same");
          ahSignalRsubPYTHIA[i]->Draw("pe same");
          ...
          if(jetetamin<0.3) cdNdrpythia->SaveAs(Form("plotfinal/cfinal_xsec_%s_r_pt_%s_%s%s_dNdrpythia.pdf",outputname.Data(),xjjc::number_to_string(ptBins[i]).c_str(),xjjc::number_to_string(ptBins[i+1]).c_str(),tname[l].Data()));
...
void verbose_binerror()
{
  ...
  for(int i=0;i<nPtBins;i++) 
    {
      std::cout<<"{";
      for(int j=0;j<nDrBins;j++) { std::cout<<ahSignalRsubMeP[0][i]->GetBinContent(j+1)<<(j==nDrBins-1?"}":", "); }
  ...
  for(int i=0;i<nPtBins;i++) 
    {
      std::cout<<"{";
      for(int j=0;j<nDrBins;j++) { std::cout<<ahSignalRsubMeP[0][i]->GetBinError(j+1)<<(j==nDrBins-1?"}":", "); }
      std::cout<<(i==nPtBins-1?"};":",")<<std::endl;
    }
  ...
  for(int i=0;i<nPtBins;i++) 
    {
      std::cout<<"{";
      for(int j=0;j<nDrBins;j++) { std::cout<<agSignalRsubMeP[0][i]->GetErrorY(j)<<(j==nDrBins-1?"}":", "); }
      std::cout<<(i==nPtBins-1?"};":",")<<std::endl;
    }
  ...
  for(int i=0;i<nPtBins;i++) 
    {
      std::cout<<"{";
      for(int j=0;j<nDrBins;j++) { std::cout<<ahSignalRsubMeP[1][i]->GetBinContent(j+1)<<(j==nDrBins-1?"}":", "); }
      std::cout<<(i==nPtBins-1?"};":",")<<std::endl;
    }
  ...
  for(int i=0;i<nPtBins;i++) 
    {
      std::cout<<"{";
      for(int j=0;j<nDrBins;j++) { std::cout<<ahSignalRsubMeP[1][i]->GetBinError(j+1)<<(j==nDrBins-1?"}":", "); }
      std::cout<<(i==nPtBins-1?"};":",")<<std::endl;
    }
  ...
  for(int i=0;i<nPtBins;i++) 
    {
      std::cout<<"{";
      for(int j=0;j<nDrBins;j++) { std::cout<<agSignalRsubMeP[1][i]->GetErrorY(j)<<(j==nDrBins-1?"}":", "); }
      std::cout<<(i==nPtBins-1?"};":",")<<std::endl;
    }
...
//         if(l || jetetamin>=0.3)c->SaveAs(Form("plotfinal/cfinal_xsec_%s_r_pt_%s_%s%s_pre.pdf",outputname.Data(),xjjc::number_to_string(ptBins[i]).c_str(),xjjc::number_to_string(ptBins[i+1]).c_str(),tname[l].Data()));
//         delete leg;
//         delete hemptyPull;
//         delete hempty;
//         delete pPull;
